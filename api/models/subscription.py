...
class Subscription(Base):
    ...
    head_id: Mapped[String] = mapped_column(String, ForeignKey('users.id'), nullable=False) # from user
    tail_id: Mapped[String] = mapped_column(String, ForeignKey('users.id'), nullable=False) # on user
    date: Mapped[String] = mapped_column(DateTime(True), nullable=False, default=tools.get_dt)
